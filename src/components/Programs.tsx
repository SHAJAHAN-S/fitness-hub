...
const programs = [
  {
    ...
    desc: "Build raw muscle with barbell, dumbbell and powerlifting protocols.",
  },
  {
    img: cardio,
    title: "HIIT & Cardio",
    desc: "Burn fat fast with high-intensity group conditioning sessions.",
  },
  {
    img: women,
    title: "Women's Fitness",
    desc: "Toning, weight-loss & body-shaping programs in a private floor.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="mt-4 text-muted-foreground">
            Pick the path that matches your goal — every program is designed and led by certified
            Master Gym coaches.
          </p>
        </div>
          ...
          {programs.map((p, i) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <a
                  href="#contact"
                  className="mt-4 inline-block text-primary font-semibold text-sm uppercase tracking-wider hover:underline"
                >
                  Join Class →
                </a>
              </div>
